...
function seedDatabase() {
  ...
  try {
    ...
    if (e.message.includes('UNIQUE')) console.log('  ✓ Admin user already exists');
  }
  ...
  const products = [
    {
      name: 'Urban Classic Polo Shirt', slug: 'urban-classic-polo-shirt',
      ...
      price: 25000, sale_price: null, category_id: catMap['mens-clothing'],
      sizes: '["S","M","L","XL","XXL"]', colors: '["White","Black","Navy","Burgundy"]',
      images: JSON.stringify([img('1552374196-c4e7ffc6e126'), img('1618517351616-38fb9c5210c6')]),
      featured: 1, new_arrival: 0, best_seller: 1, stock: 50, sku: 'UH-MP-001'
    },
    {
      name: 'Luxury Slim Fit Chinos', slug: 'luxury-slim-fit-chinos',
      ...
      price: 32000, sale_price: 28000, category_id: catMap['mens-clothing'],
      sizes: '["30","32","34","36","38"]', colors: '["Khaki","Black","Navy","Olive"]',
      images: JSON.stringify([img('1473966968600-fa801b869a1a'), img('1624378439575-d8705ad7ae80')]),
      featured: 1, new_arrival: 1, best_seller: 0, stock: 35, sku: 'UH-MC-002'
    },
    {
      name: 'Designer Denim Jacket', slug: 'designer-denim-jacket',
      ...
      price: 45000, sale_price: null, category_id: catMap['mens-clothing'],
      sizes: '["S","M","L","XL"]', colors: '["Blue","Black","Light Wash"]',
      images: JSON.stringify([img('1576871337632-b9aef4c17ab9'), img('1548126032-079a0fb0099d')]),
      featured: 1, new_arrival: 0, best_seller: 1, stock: 20, sku: 'UH-MJ-003'
    },
    {
      name: 'Premium Round Neck T-Shirt', slug: 'premium-round-neck-tshirt',
      description: 'Ultra-soft 100% combed cotton t-shirt. The perfect everyday essential with a modern fit and premium finish.',
      price: 15000, sale_price: 12000, category_id: catMap['mens-clothing'],
      sizes: '["S","M","L","XL","XXL"]', colors: '["White","Black","Grey","Navy","Olive"]',
      images: JSON.stringify([img('1521572163474-6864f9cf17ab'), img('1583743814966-8936f5b7be1a')]),
      featured: 0, new_arrival: 1, best_seller: 1, stock: 100, sku: 'UH-MT-004'
    },
    {
      name: 'Elegant Midi Dress', slug: 'elegant-midi-dress',
      ...
      price: 38000, sale_price: null, category_id: catMap['womens-clothing'],
      sizes: '["S","M","L","XL"]', colors: '["Black","Wine Red","Emerald","Royal Blue"]',
      images: JSON.stringify([img('1595777457583-95e059d581b8'), img('1572804013309-59a88b7e92f1')]),
      featured: 1, new_arrival: 1, best_seller: 1, stock: 30, sku: 'UH-WD-005'
    },
    {
      name: 'Satin Blouse', slug: 'satin-blouse',
      ...
      price: 22000, sale_price: 18000, category_id: catMap['womens-clothing'],
      sizes: '["S","M","L","XL"]', colors: '["Champagne","White","Black","Blush Pink"]',
      images: JSON.stringify([img('1564257631407-4eb379f02301'), img('1485462537746-965f33f7f6a7')]),
      featured: 1, new_arrival: 0, best_seller: 0, stock: 40, sku: 'UH-WB-006'
    },
    {
      name: 'High-Waist Palazzo Pants', slug: 'high-waist-palazzo-pants',
      ...
      price: 28000, sale_price: null, category_id: catMap['womens-clothing'],
      sizes: '["S","M","L","XL"]', colors: '["Black","White","Camel","Navy"]',
      images: JSON.stringify([img('1509631179647-0177331693ae'), img('1594938298603-c8148c4dae35')]),
      featured: 0, new_arrival: 1, best_seller: 0, stock: 45, sku: 'UH-WP-007'
    },
    {
      name: 'Premium Leather Sneakers', slug: 'premium-leather-sneakers',
      ...
      price: 55000, sale_price: 48000, category_id: catMap['shoes'],
      sizes: '["39","40","41","42","43","44","45"]', colors: '["White","Black","White/Gold"]',
      images: JSON.stringify([img('1549298916-b41d501d3772'), img('1600269452121-4f2416e55c28')]),
      featured: 1, new_arrival: 1, best_seller: 1, stock: 25, sku: 'UH-SH-008'
    },
    {
      name: 'Classic Oxford Shoes', slug: 'classic-oxford-shoes',
      ...
      price: 65000, sale_price: null, category_id: catMap['shoes'],
      sizes: '["39","40","41","42","43","44","45"]', colors: '["Black","Brown","Tan"]',
      images: JSON.stringify([img('1614252369475-531eba835eb1'), img('1533867617858-e7b97e060509')]),
      featured: 1, new_arrival: 0, best_seller: 1, stock: 15, sku: 'UH-SH-009'
    },
    {
      name: "Women's Block Heel Sandals", slug: 'womens-block-heel-sandals',
      description: 'Chic and comfortable block heel sandals. The perfect balance of style and wearability for any occasion.',
      price: 35000, sale_price: 30000, category_id: catMap['shoes'],
      sizes: '["36","37","38","39","40","41"]', colors: '["Nude","Black","Gold","Red"]',
      images: JSON.stringify([img('1543163521-1bf539c55dd2'), img('1606107557195-0e29a4b5b4aa')]),
      featured: 0, new_arrival: 1, best_seller: 0, stock: 30, sku: 'UH-SH-010'
    },
    {
      name: 'Designer Canvas Slides', slug: 'designer-canvas-slides',
      ...
      price: 18000, sale_price: null, category_id: catMap['shoes'],
      sizes: '["39","40","41","42","43","44"]', colors: '["Black","Beige","Navy"]',
      images: JSON.stringify([img('1603808033192-082d6919d3e1'), img('1575537302964-96cd47c06b1b')]),
      featured: 0, new_arrival: 0, best_seller: 0, stock: 60, sku: 'UH-SH-011'
    },
    {
      name: 'Luxury Leather Belt', slug: 'luxury-leather-belt',
      description: 'Premium Italian leather belt with a signature gold-tone buckle. The perfect finishing touch for any outfit.',
      price: 18000, sale_price: 15000, category_id: catMap['accessories'],
      sizes: '["S","M","L","XL"]', colors: '["Black","Brown","Tan"]',
      images: JSON.stringify([img('1624222247344-550fb60583dc'), img('1553062407-98eeb64c6a62')]),
      featured: 1, new_arrival: 0, best_seller: 1, stock: 50, sku: 'UH-AC-012'
    },
    {
      name: 'Designer Sunglasses', slug: 'designer-sunglasses',
      description: 'UV-protected designer sunglasses with a modern frame design. Comes in a premium branded case.',
      price: 22000, sale_price: null, category_id: catMap['accessories'],
      sizes: '["One Size"]', colors: '["Black","Tortoise","Gold"]',
      images: JSON.stringify([img('1572635196237-14b3f281503f'), img('1511499767150-a48a237f0083')]),
      featured: 0, new_arrival: 1, best_seller: 0, stock: 40, sku: 'UH-AC-013'
    },
    {
      name: 'Premium Crossbody Bag', slug: 'premium-crossbody-bag',
      ...
      price: 28000, sale_price: null, category_id: catMap['accessories'],
      sizes: '["One Size"]', colors: '["Black","Brown","Cream"]',
      images: JSON.stringify([img('1548036328-c11e31e187ce'), img('1590874103328-eac38078fee0')]),
      featured: 1, new_arrival: 1, best_seller: 0, stock: 25, sku: 'UH-AC-014'
    },
    {
      name: 'Urban Hilt Signature Cap', slug: 'urban-hilt-signature-cap',
      description: 'Our signature cap featuring embroidered Urban Hilt branding. Adjustable strap for a perfect fit.',
      price: 12000, sale_price: null, category_id: catMap['unisex'],
      sizes: '["One Size"]', colors: '["Black","White","Navy","Beige"]',
      images: JSON.stringify([img('1588850561407-ed78c334e67a'), img('1556306535-0f09a537f0a3')]),
      featured: 0, new_arrival: 0, best_seller: 1, stock: 80, sku: 'UH-UN-015'
    },
    {
      ...
      price: 35000, sale_price: 30000, category_id: catMap['unisex'],
      sizes: '["S","M","L","XL","XXL"]', colors: '["Black","Grey","Cream","Forest Green"]',
      images: JSON.stringify([img('1556821840-3a63f95609a7'), img('1578768079052-aa76e52ff62e')]),
      featured: 1, new_arrival: 1, best_seller: 1, stock: 40, sku: 'UH-UN-016'
    },
    {
      name: 'Luxury Jogger Pants', slug: 'luxury-jogger-pants',
      ...
      price: 28000, sale_price: null, category_id: catMap['unisex'],
      sizes: '["S","M","L","XL","XXL"]', colors: '["Black","Grey","Navy","Olive"]',
      images: JSON.stringify([img('1552902865-b72c031ac5ea'), img('1562157873-818bc0726f68')]),
      featured: 0, new_arrival: 0, best_seller: 0, stock: 55, sku: 'UH-UN-017'
    },
    {
      ...
      price: 20000, sale_price: 16000, category_id: catMap['unisex'],
      sizes: '["S","M","L","XL","XXL"]', colors: '["Black","White","Sand"]',
      images: JSON.stringify([img('1576566588028-4147f3842f27'), img('1503341504253-dff4f8e18d04')]),
      featured: 0, new_arrival: 1, best_seller: 0, stock: 70, sku: 'UH-UN-018'
    },
    {
      ...
      price: 55000, sale_price: null, category_id: catMap['mens-clothing'],
      sizes: '["S","M","L","XL"]', colors: '["Black","Navy","Charcoal"]',
      images: JSON.stringify([img('1507679799987-c73779587ccf'), img('1594938298603-c8148c4dae35')]),
      featured: 1, new_arrival: 0, best_seller: 0, stock: 20, sku: 'UH-MB-019'
    },
    {
      name: 'Silk Wrap Dress', slug: 'silk-wrap-dress',
      ...
      price: 48000, sale_price: 42000, category_id: catMap['womens-clothing'],
      sizes: '["S","M","L","XL"]', colors: '["Black","Burgundy","Forest Green","Champagne"]',
      images: JSON.stringify([img('1496747611176-843222e1e57c'), img('1515886657613-9f3515b0c78f')]),
      featured: 1, new_arrival: 1, best_seller: 1, stock: 20, sku: 'UH-WD-020'
    },
  ];
  ...
  // Seed sample reviews
  const reviewStmt = db.prepare('INSERT OR IGNORE INTO reviews (product_id, customer_name, rating, title, comment, verified) VALUES (?, ?, ?, ?, ?, ?)');
  const productIds = db.prepare('SELECT id, slug FROM products').all();
  const pidMap = {};
  ...
  reviews.forEach(r => { try { reviewStmt.run(...r); } catch(e) {} });
